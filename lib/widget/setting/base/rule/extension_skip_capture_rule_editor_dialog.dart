...
class ExtensionSkipCaptureRuleEditorDialog extends StatefulWidget {
  const ExtensionSkipCaptureRuleEditorDialog({
    super.key,
  });

  @override
  _ExtensionSkipCaptureRuleEditorDialogState createState() =>
      _ExtensionSkipCaptureRuleEditorDialogState();
}
...
class _ExtensionSkipCaptureRuleEditorDialogState
  ...
  void _onAddNewPressed() {
    setState(() {
      rules.add(
        FileRule(condition: FileCondition.fileExtensionIs, value: ""),
      );
